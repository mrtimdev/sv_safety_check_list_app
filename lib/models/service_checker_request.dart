...
class ServiceCheckerRequest {
  ...
  factory ServiceCheckerRequest.fromJson(Map<String, dynamic> json) {
    print("📦 Parsing ServiceCheckerRequest from JSON: $json");

    return ServiceCheckerRequest(
      id: json['id'],
