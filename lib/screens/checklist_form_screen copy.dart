...
//   final ServiceCheckerRequest? checklistToEdit;
...
//       _inspections = widget.checklistToEdit!.items.map((item) {
//         return Inspection(
//           itemId: item.id,
//           itemName: item.name,
//           passed: item.passed,
...
//         );
//       }).fold({}, (map, inspection) {
//         final categoryId = widget.checklistToEdit!.items
//                 .firstWhere((i) => i.id == inspection.itemId)
//                 .categoryId ??
//             0;
//         if (!map.containsKey(categoryId)) {
//           map[categoryId] = [];
//         }
//         map[categoryId]!.add(inspection);
//         return map;
//       });
//     }
//   }
...
//       // Prepare the complete request data matching Spring Boot ServiceCheckerRequestRequest
...
//                       return 'សូមបញ្ចូលផ្លាកលេខរថយន្ត';
//                     }
//                     if (value.length < 3) {
